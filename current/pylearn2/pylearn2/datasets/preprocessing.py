...
class PCA(object):
    def __init__(self, num_components, keep_var_fraction):
        # We keep the largest num_components eigenvalues, or keep enough 
        # eigenvalues to capture keep_var_fraction of the original variance,
        # whichever is less.
